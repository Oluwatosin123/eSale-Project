            ...
            <form @submit.prevent="login" class="form-area2 text-left">
              <div class="text-box">
                <h1 class="heading-primary h4 d-block text-center mb-2">
                  <span class="heading-primary-main">Welcome Back</span
                  ><i class="fa fa-heart ml-2 text-danger"></i>
                  <span class="heading-primary-sub h6 d-block"
                    ><small>Login to your Account</small></span>
                </h1>
              </div>
