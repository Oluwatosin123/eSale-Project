  ...
  <div class="products">
    <div class="container products pt-5">
      ...
      <div class="row h-100">
        ...
        <div class="col-6 col-md-4 justify-content-center align-items-center  text-right">
           <h3>Products Page</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<br>
            Laboriosam reprehenderit molestias sed modi ea.</p>
        </div>
           ...
           <table class="table">
                      ...
                      <tbody>
                        <tr v-for="product in products" :key="product">
                          ...
                          <td>
                            <button @click="editProduct(product)" class="btn btn-primary btn-sm mr-2">Edit</button>
                            <button @click="deleteProduct(product.id)" class="btn btn-danger btn-sm mr-2">Delete</button>
                          </td>
                        </tr>
                      </tbody>
          </table>
